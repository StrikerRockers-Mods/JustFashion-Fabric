...
public class LayerFashion extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public PlayerModel<AbstractClientPlayer> body = new PlayerModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(FashionModels.NORMAL_MODEL_LOCATION), false);
    ...
    public LayerFashion(RenderLayerParent<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> renderLayerParent) {
